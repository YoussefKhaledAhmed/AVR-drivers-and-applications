...
STATUS DIO_setupPinDirection(DIO_PinDirectionConfigurations * configurations){
	uint8 PORT = configurations->Pinconfiguration->port_num;
	uint8 PIN = configurations->Pinconfiguration->pin_num;
